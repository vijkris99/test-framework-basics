...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role hub -port 8888
...
@Echo on
java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role hub