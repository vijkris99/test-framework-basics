...
REM This includes options for running Selenium as a RemoteWebDriver server, or as a Selenium Grid hub/node
...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -browser "browserName=internet explorer" -browser browserName=chrome
...
REM java -Dwebdriver.ie.driver="H:\\Javalibs\\Selenium\\Browser Drivers\\IEDriverServer.exe" -Dwebdriver.chrome.driver="H:\\Javalibs\\Selenium\\Browser Drivers\\chromedriver.exe" -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register
...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -browser browserName=chrome,maxInstances=3 -browser browserName=firefox,maxInstances=3
...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -browser "browserName=internet explorer",version=11
...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -browser "browserName=internet explorer",platform=WINDOWS
...
@Echo on
java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register